...
liebe1 <- subgraph.edges(beb1,E(beb1)[beziehung == 1 ])
liebe1

plot(liebe1, vertex.size=15, layout=durchmesser*14.0, rescale=FALSE, ylim=c(-8.0,8.0),xlim=c(-8.0,8.0),asp=0,
...
liebe2 <- subgraph.edges(beb2,E(beb2)[beziehung == 1 ])
liebe2

plot(liebe2, vertex.size=15, layout=durchmesser*14.0, rescale=FALSE, ylim=c(-8.0,8.0),xlim=c(-8.0,8.0),asp=0,
     main= "Liebesbeziehungen Buch 1 ")
plot(liebe2)
```
