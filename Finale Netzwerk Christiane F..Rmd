...
```
```{r Drogen für alle Gefühlsbeziehungen aus buch 1 & 2 } 
...
plot(cf, vertex.size=6, edge.width=2, vertex.label=NA, layout=layout_nicely) 

```
```{r Buch 1 - Gefühlsbeziehungen} 

#V(b1)$degree <- degree(b1) 
#vertex.attributes(b1)$degree 
#b1_relations <- delete_vertices(b1,V(b1)[degree == "0"]) 
b1_relations 
plot (b1_relations) 

E(b1_relations)[E(b1_relations)$beziehung == 1]$color <- "lightblue" 
E(b1_relations)[E(b1_relations)$beziehung == 2]$color <- "turquoise" 
E(b1_relations)[E(b1_relations)$beziehung == 3]$color <- "blue" 
E(b1_relations)[E(b1_relations)$beziehung == 4]$color <- "darkblue" 
E(b1_relations)[E(b1_relations)$beziehung == 5]$color <- "grey" 
E(b1_relations)[E(b1_relations)$beziehung == 6]$color <- "black" 
E(b1_relations)[E(b1_relations)$beziehung == 7]$color <- "lightpink" 
E(b1_relations)[E(b1_relations)$beziehung == 8]$color <- "pink" 
E(b1_relations)[E(b1_relations)$beziehung == 9]$color <- "red" 
E(b1_relations)[E(b1_relations)$beziehung == 10]$color <- "darkred" 
E(b1_relations)[E(b1_relations)$beziehung == 11]$color <- "yellow"

E(b1_relations)[E(b1_relations)$beziehung2 == 1]$color <- "lightblue"
E(b1_relations)[E(b1_relations)$beziehung2 == 2]$color <- "turquoise" 
E(b1_relations)[E(b1_relations)$beziehung2 == 3]$color <- "blue" 
E(b1_relations)[E(b1_relations)$beziehung2 == 4]$color <- "darkblue" 
E(b1_relations)[E(b1_relations)$beziehung2 == 5]$color <- "grey" 
E(b1_relations)[E(b1_relations)$beziehung2 == 6]$color <- "black" 
E(b1_relations)[E(b1_relations)$beziehung2 == 7]$color <- "lightpink" 
E(b1_relations)[E(b1_relations)$beziehung2 == 8]$color <- "pink" 
E(b1_relations)[E(b1_relations)$beziehung2 == 9]$color <- "red" 
E(b1_relations)[E(b1_relations)$beziehung2 == 10]$color <- "darkred" 
E(b1_relations)[E(b1_relations)$beziehung2 == 11]$color <- "yellow" 
b1_relations 
layouts <- grep("^layout_", ls("package:igraph"), value=TRUE)[-1] 
plot(b1_relations, vertex.size=6, edge.width=2, vertex.label=NA) 
```
```{r Buch 2 - Gefühlsbeziehungen} 
V(b2)$degree <- degree(b2) 
vertex.attributes(b2)$degree 
b2_relations <- delete_vertices(b2,V(b2)[degree == "0"]) 
b2_relations 

E(b2_relations)[E(b2_relations)$beziehung == 1]$color <- "lightblue" 
E(b2_relations)[E(b2_relations)$beziehung == 2]$color <- "turquoise" 
E(b2_relations)[E(b2_relations)$beziehungen == 3]$color <- "blue" 
E(b2_relations)[E(b2_relations)$beziehungen == 4]$color <- "darkblue" 
E(b2_relations)[E(b2_relations)$beziehungen == 5]$color <- "grey" 
E(b2_relations)[E(b2_relations)$beziehung == 6]$color <- "black" 
E(b2_relations)[E(b2_relations)$beziehung == 7]$color <- "lightpink" 
E(b2_relations)[E(b2_relations)$beziehungen == 8]$color <- "pink" 
E(b2_relations)[E(b2_relations)$beziehungen == 9]$color <- "red" 
E(b2_relations)[E(b2_relations)$beziehungen == 10]$color <- "darkred" 
E(b2_relations)[E(b2_relations)$beziehungen == 11]$color <- "yellow" 
E(b2_relations)[E(b2_relations)$beziehung2 == 1]$color <- "lightblue" 
E(b2_relations)[E(b2_relations)$beziehung2 == 2]$color <- "turquoise" 
E(b2_relations)[E(b2_relations)$beziehungen2 == 3]$color <- "blue" 
E(b2_relations)[E(b2_relations)$beziehungen2 == 4]$color <- "darkblue" 
E(b2_relations)[E(b2_relations)$beziehungen2 == 5]$color <- "grey" 
E(b2_relations)[E(b2_relations)$beziehung2 == 6]$color <- "black" 
E(b2_relations)[E(b2_relations)$beziehung2 == 7]$color <- "lightpink" 
E(b2_relations)[E(b2_relations)$beziehungen2 == 8]$color <- "pink" 
E(b2_relations)[E(b2_relations)$beziehungen2 == 9]$color <- "red" 
E(b2_relations)[E(b2_relations)$beziehungen2 == 10]$color <- "darkred" 
E(b2_relations)[E(b2_relations)$beziehungen2 == 11]$color <- "yellow" 
b2_relations 
layouts <- grep("^layout_", ls("package:igraph"), value=TRUE)[-1] 
plot(b2_relations, vertex.size=6, edge.width=2) 
```
